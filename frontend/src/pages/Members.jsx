...
export default function Members() {
  ...
  const handleResetPw = async e => {
    ...
    try {
      ...
      showMsg('success','Password reset.'); setResetId(null); setResetPw('');
              ...
              <>
                  ...
                  <>
                    <div className="section-header" style={{ marginBottom:14 }}>
                      <div>
                        ...
                        <div className="section-subtitle">Full access to this workspace</div>
                      </div>
                    </div>
                ...
                <div className="section-header" style={{ marginBottom:14 }}>
                  <div>
                    ...
                    <div className="section-subtitle">Access to assigned projects only</div>
                  </div>
                </div>
                ...
                {regular.length===0 ? (
                  <div className="empty-state">
                    ...
                    <p>Add members directly or share an invite link / code from the Invitations page.</p>
                  </div>
                ) : (
          ...
          <div className="card" style={{ maxWidth:560 }}>
            ...
            <div className="card-body">
              <div className="notice" style={{
                ...
                ℹ Accounts created here are immediately active — no verification needed.
                For invite links and project codes, use the <strong>Invitations</strong> page.
              </div>
              <form onSubmit={handleCreate}>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <div className="form-hint">Share this securely with them.</div>
                  </div>
                  <div className="form-group">
            ...
            <div className="info-grid">
              <div className="info-card indigo">
                ...
                <div className="info-card-body">
                  Manages all projects and members within this workspace.
                  Cannot see data from other workspaces.
                </div>
              </div>
              <div className="info-card green">
                <div className="info-card-title">👤 Researcher</div>
                <div className="info-card-body">
                  Submits expenses for assigned projects only.
                  Cannot see other members' expenses.
                </div>
              </div>
              <div className="info-card amber">
                <div className="info-card-title">✉️ Invite members</div>
                <div className="info-card-body">
                  Use the Invitations page to generate invite links (email-locked)
                  or project codes (for WhatsApp groups).
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="modal-body">
                <div className="form-group">
                  ...
                  <div className="form-hint">
                    Share this securely. They can change it from their Profile page.
                  </div>
                </div>
              </div>
              <div className="modal-foot">
                ...
                <button type="submit" className="btn btn-primary"
                  disabled={saving||resetPw.length<8}>
...
function MemberCard({ m, i, isMe, onEdit, onResetPw, onDelete, onView, colors }) {
  return (
    <div className="member-card"
      style={{ borderTop:`3px solid ${m.role==='admin'?'var(--accent)':'var(--border-strong)'}` }}>
      <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:12 }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          {m.position && (
            <div style={{ fontSize:11, color:'var(--text-tertiary)', marginTop:2 }}>{m.position}</div>
          )}
        </div>
      </div>
